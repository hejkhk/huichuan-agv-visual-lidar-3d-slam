...
class SlamCorrectionGuard(Node):
    ...
    def __init__(self) -> None:
        ...
        self.declare_parameter("translation_threshold_m", 0.20)
        self.declare_parameter("yaw_threshold_deg", 5.0)
        self.declare_parameter("window_sec", 0.50)
        self.declare_parameter("window_translation_threshold_m", 0.30)
        self.declare_parameter("window_yaw_threshold_deg", 6.00)
        self.declare_parameter("max_sample_gap_sec", 1.0)
        self.declare_parameter("hold_sec", 1.00)
