...
-- Bootstrap follows the known-good all.beifen global localization profile.
-- The tight runtime trajectory re-enables the project's IMU constraints.
...
POSE_GRAPH.constraint_builder.fast_correlative_scan_matcher.linear_search_window = 30.0
POSE_GRAPH.constraint_builder.fast_correlative_scan_matcher.angular_search_window = math.pi
POSE_GRAPH.constraint_builder.fast_correlative_scan_matcher.branch_and_bound_depth = 9
