...
struct FrontierExplorerCoreParams
{
  ...
  bool active_goal_blocked_cancel_enabled{true};
  ...
  int completion_confirmation_count{8};
  bool complete_when_all_frontiers_suppressed{false};
  int all_frontiers_suppressed_confirmation_count{8};
  int all_frontiers_suppressed_max_known_cell_growth{20};
...
public:
  ...
  bool confirm_all_frontiers_suppressed_completion(
    const geometry_msgs::msg::Pose & current_pose);
  void reset_all_frontiers_suppressed_completion_tracking();
  ...
  void feedback_callback(double distance_remaining, int number_of_recoveries, int dispatch_id);
  ...
  int empty_frontier_confirmation_count{0};
  std::optional<int> empty_frontier_last_map_generation;
  int all_frontiers_suppressed_confirmation_hits{0};
  std::optional<int> all_frontiers_suppressed_last_map_generation;
  std::optional<std::size_t> all_frontiers_suppressed_baseline_known_cell_count;
...
private:
  ...
  void note_active_goal_progress(double distance_remaining, int number_of_recoveries);
