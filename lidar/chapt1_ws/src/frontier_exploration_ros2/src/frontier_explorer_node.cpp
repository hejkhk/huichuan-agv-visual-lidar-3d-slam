...
: Node("frontier_explorer", options)
{
  ...
  this->declare_parameter<bool>("active_goal_blocked_cancel_enabled", true);
  ...
  this->declare_parameter<int>("completion_confirmation_count", 8);
  this->declare_parameter<bool>("complete_when_all_frontiers_suppressed", false);
  this->declare_parameter<int>("all_frontiers_suppressed_confirmation_count", 8);
  this->declare_parameter<int>("all_frontiers_suppressed_max_known_cell_growth", 20);
  ...
  params_.active_goal_blocked_cancel_enabled = this->get_parameter(
    "active_goal_blocked_cancel_enabled").as_bool();
  ...
  params_.completion_confirmation_count = this->get_parameter(
    "completion_confirmation_count").as_int();
  params_.complete_when_all_frontiers_suppressed = this->get_parameter(
    "complete_when_all_frontiers_suppressed").as_bool();
  params_.all_frontiers_suppressed_confirmation_count = this->get_parameter(
    "all_frontiers_suppressed_confirmation_count").as_int();
  params_.all_frontiers_suppressed_max_known_cell_growth = this->get_parameter(
    "all_frontiers_suppressed_max_known_cell_growth").as_int();
  ...
  RCLCPP_INFO(
    this->get_logger(),
    "Terminal suppressed-frontier completion: enabled=%s, confirmation_count=%d, max_known_cell_growth=%d",
    core_->params.complete_when_all_frontiers_suppressed ? "true" : "false",
    core_->params.all_frontiers_suppressed_confirmation_count,
    core_->params.all_frontiers_suppressed_max_known_cell_growth);
  ...
  RCLCPP_INFO(
    this->get_logger(),
    "Using post-goal settle config: enabled=%s, post_goal_min_settle=%.2fs, map_processing_rate_hz=%.2f, completion_confirmation_count=%d, all_frontiers_suppressed_behavior=%s",
    params_.post_goal_settle_enabled ? "true" : "false",
    params_.post_goal_min_settle,
    params_.map_processing_rate_hz,
    core_->params.completion_confirmation_count,
