...
log "  LiDAR scan gate : complete wrap, raw >=${FIXED_SCAN_MIN_RAW_POINTS:-180}, valid >=${FIXED_SCAN_MIN_VALID_POINTS:-0}"
...
cmd=(ros2 launch lidar_py dual_resolution_3d_slam.launch.py
  ...
  "rgbd_sync_warn_p95_ms:=${RGBD_SYNC_WARN_P95_MS:-45.0}"
